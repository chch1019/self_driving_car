...
ros2 run self_driving_car spawner_node $red_light_sdf red_light 
sleep 7.5
ros2 run self_driving_car spawner_node $yellow_light_sdf yellow_light 
sleep 1
ros2 run self_driving_car spawner_node $green_light_sdf green_Light 
